...
while True:
    ...
    bounding_box = generate_bounding_box_after_pnet(face, prob, .45, cell_size=(square_side // 4, square_side // 4))
    ...
    thickness = 2
    cv2.rectangle(square_frame, (x1, y1), (x2, y2), color, thickness)
